/**
 * main.js - Main application entry point with auth integration
 */
...
async function initializePlayerPage() {
    ...
    try {
        ...
        // Initialize favorites and collections UI
        const metadata = player.showMetadata || {};
        initFavoriteButton(
            identifier,
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Initialize authentication (non-blocking — works without backend)
    try {
        await initAuth();
    } catch (e) {
        console.warn('Auth init skipped (backend may be offline):', e.message);
    }
